...
<div class="contentBody">
    ...
    <div id="data">
        ...
        <form action="ajaxDPParse.html" method="post" id="dpForm">
            <s:textarea name="inputSentence" cssClass="inputData" rows="3" id="inputSentence"></s:textarea>
    ...
    <div id="showResult">
        ...
        <div class="left"><span class="connWord">Connective: </span><s:property value="connWord"/></div>
        <div class="left"><span class="arg2">Arg1Content:</span> <s:property value="arg1"/></div>
        <div class="left"><span class="arg1">Arg2Content: </span><s:property value="arg2"/></div>
        <div class="left"><span class="relType">SenseType: </span><s:property value="expRelType"/></div>
        <div class="left"><span class="relType">Probality: </span><s:property value="expRelProbality"/></div>
    </div>
