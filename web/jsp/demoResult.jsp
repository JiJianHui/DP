...
<div class="contentBody">
    ...
    <div id="data">
        ...
        <div id="examples">
            ...
            <select name="multiSentences" class="long_select" id="multiSentences" onchange="getMultiData()">
            ...
            <label><input name="needSegment" type="radio" value="true" />需要分词 </label>
            <label><input name="needSegment" type="radio" value="false" checked/>不需要分词</label>
